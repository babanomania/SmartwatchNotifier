...
package com.babanomania.tasker.notifier.bundle;
...
public final class Constants
{
     ...
     */
    public static final boolean IS_LOGGABLE = false;//BuildConfig.DEBUG;

    /**
     * Flag to enable runtime checking of method parameters.
     */
    public static final boolean IS_PARAMETER_CHECKING_ENABLED = false;//BuildConfig.DEBUG;

    /**
     * Flag to enable runtime checking of whether a method is called on the correct thread.
     */
    public static final boolean IS_CORRECT_THREAD_CHECKING_ENABLED = false;//BuildConfig.DEBUG;
